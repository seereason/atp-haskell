...
-- Example.
mk_knows :: forall formula a. IsPropositional formula (Knows a) => String -> a -> formula
...
mk_adder_test :: forall formula atom a. (IsPropositional formula atom, atom ~ Knows a, Ord a, Ord formula, Num a, Enum a) =>
                 a -> a -> formula
mk_adder_test n k =
