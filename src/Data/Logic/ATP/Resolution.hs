...
resolvents :: (JustLiteral lit, Ord lit, HasApply atom, Unify atom atom v term, IsTerm term,
               atom ~ AtomOf lit, term ~ TermOf atom, v ~ TVarOf term) =>
...
resolve_clauses :: (JustLiteral lit, Ord lit, HasApply atom, Unify atom atom v term, IsTerm term,
                    atom ~ AtomOf lit, term ~ TermOf atom, v ~ TVarOf term) =>
...
resloop1 :: (JustLiteral lit, Ord lit, HasApply atom, IsTerm term, Unify atom atom v term,
             atom ~ AtomOf lit, term ~ TermOf atom, v ~ TVarOf term) =>
...
resolution1 :: forall m fof atom term v function.
               (IsFirstOrder fof, Unify atom atom v term, Ord fof, HasSkolem function, Monad m,
...
resolution2 :: forall fof atom term v function m.
               (IsFirstOrder fof, Unify atom atom v term, Match (atom, atom) v term, HasSkolem function, Monad m, Ord fof,
                atom ~ AtomOf fof, term ~ TermOf atom, function ~ FunOf term, v ~ TVarOf term, v ~ SVarOf function) =>
               fof -> SkolemT m function (Set (Failing Bool))
...
pure_resolution2 :: forall fof atom term v.
                    (IsFirstOrder fof, Ord fof, Pretty fof,
                     ...
                     Unify atom atom v term, Match (atom, atom) v term,
                     atom ~ AtomOf fof, term ~ TermOf atom, v ~ TVarOf term) =>
                    fof -> Failing Bool
...
presolution :: forall fof atom term v function m.
               (IsFirstOrder fof, Unify atom atom v term, Match (atom, atom) v term, HasSkolem function, Monad m, Ord fof, Pretty fof,
...
pure_presolution :: forall fof atom term v.
                    (IsFirstOrder fof, Unify atom atom v term, Match (atom, atom) v term, Ord fof, Pretty fof,
...
presloop :: (JustLiteral lit, Ord lit, HasApply atom, IsTerm term,
             Match (atom, atom) v term, Unify atom atom v term,
             atom ~ AtomOf lit, term ~ TermOf atom, v ~ TVarOf term) =>
            Set (Set lit) -> Set (Set lit) -> Failing Bool
...
presolve_clauses :: (JustLiteral lit, Ord lit, HasApply atom, IsTerm term, Unify atom atom v term,
                     atom ~ AtomOf lit, term ~ TermOf atom, v ~ TVarOf term) =>
                    Set lit -> Set lit -> Set lit
